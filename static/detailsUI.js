...
export function initDetailsUI(pokemons, pokemonBaseList, pokemonSelfList) {
  ...
  return function afficherDetail(poke, varianteIndex = 0, variantes = null) {
    ...
    detectMaxTileInFolder(poke.numero, "POKEMON_BASE", pokemonBaseList, pokemonSelfList, function (maxTile) {
      ...
      function renderPreview() {
        ...
        detectMaxTileInFolder(poke.numero, folder, pokemonBaseList, pokemonSelfList, function (maxTile) {
          if (isNaN(currentTile) || currentTile < 1 || currentTile > maxTile)
            currentTile = 1;
          previewContainer.innerHTML = "";
